#!/usr/bin/env python3
"""Generate OG images for new tools and blog posts on DevToolbox."""
...
IMAGES = [
    ("tool-hex-rgb-converter.png", "Hex to RGB Converter", "Color Code Converter"),
    ("tool-ascii-table.png", "ASCII Table", "Character Codes Chart"),
    ("tool-image-resizer.png", "Image Resizer", "Resize Images Online"),
    ("tool-color-palette-generator.png", "Color Palette Generator", "Create Color Schemes"),
    ("blog-hex-color-codes-guide.png", "Hex Color Codes", "Complete Developer Guide"),
    ("blog-ascii-codes-reference.png", "ASCII Codes", "Complete Reference Guide"),
]
